...
- **`wearable-assistant`** — носимый AI-кулон с DeepSeek и памятью, рабочее название. Заказ еды, бронь столов, заметки, бытовые задачи. Двухстадийная сборка: ESP32-S3-BOX-3 (без пайки) → DIY-кулон. Стадия 0 — ждём заказа железа и имени.
